...
#' 
#' @description R6 base class for Hampton Inundation 
#' @export
Hampton_Physics <-  R6::R6Class("Hampton_Physics",
...
HamptonPhysics <- function(filename = file.path("http://www.smast.umassd.edu:8080",
                                              "thredds/dodsC/models/fvcom/NECOFS/Forecasts",
                                              "NECOFS_FVCOM_OCEAN_HAMPTON_FORECAST.nc"),
                         ...){
  Hampton_Physics$new(filename, ...)
}